...
public class ClienteRestController {
    ...
    public List<Pedido> obtenerHistorialPedidos(@PathVariable String clienteId) {
    ...
    public Cliente actualizarClientePatch(@PathVariable String clienteId,
    ...
    public Cliente desactivarCliente(@PathVariable String id) {
        clienteService.desactivarPorId(id);
        return clienteService.obtenerPorId(id);
    }

    @DeleteMapping("/clientes/{clienteId}")
    public String borrarCliente(@PathVariable String clienteId) {
