...
public class PedidoRestController {
    ...
    public Pedido obtenerPedidoPorId(@PathVariable int pedidoId) {
    ...
    public List<Pedido> obtenerPedidoPorClienteId(@PathVariable int clienteId) {
    ...
    public Pedido cambiarEstadoPedido(@PathVariable int id, @RequestBody Map<String, String> body) {
    ...
    public String borrarPedido(@PathVariable int pedidoId) {
